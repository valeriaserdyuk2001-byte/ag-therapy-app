...
export function renderResultPage(root, rerender) {
  ...
  root.innerHTML = `
    <div class="container">
      ...
      <p class="page-subtitle">Данные рекомендации основаны на общих клинических руководствах и должны использоваться только в качестве инструмента поддержки принятия решений. Всегда учитывайте индивидуальные обстоятельства пациента, противопоказания, лекарственные взаимодействия и действующие научно обоснованные рекомендации по лечению. Этот инструмент не заменяет клиническое суждение или экспертные знания врача.</p>
