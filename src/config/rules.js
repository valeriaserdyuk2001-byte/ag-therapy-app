...
export const DEFAULT_RULES = {
  ...
  cha2vascStrokeRisk: {
    ...
    3: '3,2',
    4: '4,0',
    5: 'значение требует уточнения в конфиге',
    6: '9,8',
    7: '9,6',
    8: 'значение требует уточнения в конфиге',
    9: '15,2',
  },
  statinTargets: {
    ...
    standard: {
      ...
      steps: {
        ...
        3: {
          ...
          classPlan: 'ИАПФ или БРА + БКК + диуретик',
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + диуретик + БКК + АМКР или ББ или АИР или ААБ в оптимальной дозе',
    ...
    ckdEarly: {
      ...
      steps: {
        ...
        2: {
          ...
          classPlan: 'ИАПФ или БРА + БКК или Т/ТП диуретик',
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + БКК + Т/ТП диуретик в оптимальной дозе',
          warning: 'при переносимости',
        },
        3: {
          label: '3 шаг',
          ...
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + БКК + Т/ТП диуретик + АМКР или ББ или ААБ или АИР в оптимальной дозе',
          warning: 'при переносимости',
        },
      },
    },
    ckdLate: {
      ...
      steps: {
        ...
        2: {
          ...
          classPlan: 'ИАПФ или БРА + БКК или петлевой диуретик',
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + БКК + петлевой диуретик в оптимальной дозе',
          warning: 'при переносимости',
        },
        3: {
          label: '3 шаг',
          ...
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + БКК + петлевой диуретик + Т/ТП диуретик или ББ или ААБ или АИР в оптимальной дозе',
          warning: 'при переносимости',
        },
      },
    },
    ihdAngina: {
      ...
      steps: {
        ...
        2: {
          ...
          classPlan: 'ИАПФ или БРА + ББ',
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + ББ + дигидропиридиновые БКК в оптимальной дозе',
          warning: 'при переносимости',
        },
        3: {
          label: '3 шаг',
          ...
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + ББ + дигидропиридиновые БКК + АМКР или диуретик или ААБ или АИР в оптимальной дозе',
          warning: 'при переносимости',
        },
      },
    },
    ihdNoAngina: {
      ...
      steps: {
        ...
        2: {
          ...
          classPlan: 'ИАПФ или БРА + ББ',
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + ББ + дигидропиридиновые БКК или Т/ТП диуретики в оптимальной дозе',
          warning: 'при переносимости',
        },
        3: {
          label: '3 шаг',
          ...
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + ББ + дигидропиридиновые БКК или Т/ТП диуретики + АМКР или диуретик или ААБ или АИР в оптимальной дозе',
          warning: 'при переносимости',
        },
      },
    },
    afFast: {
      ...
      steps: {
        ...
        3: {
          ...
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + ББ + дигидропиридиновые БКК + Т/ТП диуретики + АМКР или диуретик или ААБ или АИР в оптимальной дозе',
          warning: 'при переносимости',
        },
      },
    },
    afSlow: {
      ...
      steps: {
        ...
        2: {
          ...
          classPlan: 'ИАПФ или БРА + дигидропиридиновые БКК или Т/ТП диуретик',
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + дигидропиридиновые БКК + Т/ТП диуретики в оптимальной дозе',
          warning: 'при переносимости',
        },
        3: {
          label: '3 шаг',
    ...
    oncology: {
      ...
      steps: {
        ...
        2: {
          ...
          classPlan: 'ИАПФ или БРА + дигидропиридиновые БКК',
          doseLevel: 'maximal',
          alternatives: 'ИЛИ ИАПФ или БРА + дигидропиридиновые БКК + АМКР или ББ или диуретик в оптимальной дозе',
          warning: 'при переносимости',
        },
      },
    },
